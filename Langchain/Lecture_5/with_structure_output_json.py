# In this code we will learn how to use Json schema 
...
structured_model = model.with_structured_output(json_schema) # we have defined how the strucrure should be
